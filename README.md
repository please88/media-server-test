* Build Dependence: https://github.com/please88/sdk
* Build Dependence: https://github.com/please88/media-server
...
### Make
1. make clean && make
2. ./hls-ts-test source.200kbps.768x320.flv 
3. ./hls-fmp4-test source.200kbps.768x320.flv 
